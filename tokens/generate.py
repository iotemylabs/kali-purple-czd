...
def gen_kde_colors(t: Tokens, out: Out):
    ...
    L += ["[General]", "ColorScheme=CZDPurple", "Name=CZD Purple", "shadeSortColumn=true",
    ...
    out.write("czd-plasma-theme", "usr/share/color-schemes/CZDPurple.colors", "\n".join(L))
...
GENERATORS = [gen_tokens_package, gen_konsole, gen_gtk, gen_xresources, gen_vim, gen_kvantum, gen_kde_colors, gen_wireshark]
